...
BookmarkNodeManager::BookmarkNodeManager(QObject *parent) :
    QObject(parent),
    m_rootNode(nullptr),
...
BookmarkNodeManager::~BookmarkNodeManager()
{
}

BookmarkNode *BookmarkNodeManager::getRoot() const
{
    return m_rootNode;
}

BookmarkNode *BookmarkNodeManager::getBookmarksBar() const
{
    return m_bookmarkBar;
}

BookmarkNode *BookmarkNodeManager::getBookmark(const QUrl &url)
{
    if (url.isEmpty())
        return nullptr;
...
bool BookmarkNodeManager::isBookmarked(const QUrl &url)
{
    if (url.isEmpty())
        return false;
...
void BookmarkNodeManager::appendBookmark(const QString &name, const QUrl &url, BookmarkNode *folder)
{
...
void BookmarkNodeManager::insertBookmark(const QString &name, const QUrl &url, BookmarkNode *folder, int position)
{
    if (!folder)
        folder = getBookmarksBar();
...
BookmarkNode *BookmarkNodeManager::addFolder(const QString &name, BookmarkNode *parent)
{
...
void BookmarkNodeManager::removeBookmark(const QUrl &url)
{
    if (url.isEmpty())
        return;
...
void BookmarkNodeManager::removeBookmark(BookmarkNode *item)
{
...
void BookmarkNodeManager::setBookmarkName(BookmarkNode *bookmark, const QString &name)
{
...
BookmarkNode *BookmarkNodeManager::setBookmarkParent(BookmarkNode *bookmark, BookmarkNode *parent)
{
...
void BookmarkNodeManager::setBookmarkPosition(BookmarkNode *bookmark, int position)
{
...
void BookmarkNodeManager::setBookmarkShortcut(BookmarkNode *bookmark, const QString &shortcut)
{
...
void BookmarkNodeManager::setBookmarkURL(BookmarkNode *bookmark, const QUrl &url)
{
...
void BookmarkNodeManager::setRootNode(BookmarkNode *node)
{
    if (!node)
        return;
...
void BookmarkNodeManager::scheduleResetList()
{
    if (m_canUpdateList)
        QtConcurrent::run(this, &BookmarkNodeManager::resetBookmarkList);
}

void BookmarkNodeManager::setCanUpdateList(bool value)
{
